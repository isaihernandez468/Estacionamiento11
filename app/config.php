...
try{
    $pdo = new PDO($servidor,USUARIO,PASSWORD,array(PDO::MYSQL_ATTR_INIT_COMMAND=>"SET NAMES utf8"));   /*aqui ya estamos haciendo la conexion*/
...
$URL = "http://localhost/Estacionamiento1";
